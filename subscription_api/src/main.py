...
app.include_router(
    ...
    prefix="/subscription/api/billing/v1/subscription_plans",
    tags=["subscription_plans"],
)
app.include_router(
    subscription_router,
    prefix="/subscription/api/billing/v1/subscriptions",
    tags=["subscriptions"],
)
app.include_router(
    transaction_router,
    prefix="/subscription/api/billing/v1/transactions",
    tags=["transactions"],
)
app.include_router(
    refund_router, prefix="/subscription/api/billing/v1/refunds", tags=["refunds"]
)
